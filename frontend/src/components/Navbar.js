...
export default function Navbar() {
    ...
    return (_jsx("header", { className: "bg-white/90 backdrop-blur border-b sticky top-0 z-20", children: _jsxs("div", { className: "container-page h-16 flex items-center justify-between", children: [_jsxs(Link, { to: "/", className: "flex items-center gap-3", children: [_jsx("img", { src: "/logo.jpg", alt: "Crimson Academy", className: "h-9 w-9 rounded-lg object-cover ring-1 ring-neutral-100" }), _jsxs("div", { className: "flex flex-col leading-tight", children: [_jsx("span", { className: "text-lg font-bold", style: { fontFamily: '"Crimson Text", Georgia, serif' }, children: "Crimson Academy" }), _jsx("span", { className: "text-xs text-neutral-600 -mt-0.5", children: "Student Management" })] })] }), _jsxs("nav", { className: "flex items-center gap-1", children: [tabs.map(t => {
                        ...
                        }), _jsxs("div", { className: "ml-2 flex items-center gap-2", children: [_jsx(Link, { to: "/register", className: "btn-ghost", children: "Sign up" }), _jsx("button", { className: "btn-primary", children: "Sign in" })] })] })] }) }));
}
